...
#define KMS_APP_KEY_OBJECT_HANDLE                    (KMS_INDEX_MIN_NVM_STATIC_OBJECTS + 0UL)
#define KMS_NWK_KEY_OBJECT_HANDLE                    (KMS_INDEX_MIN_NVM_STATIC_OBJECTS + 1UL)
#define KMS_DEVJOINEUIADDR_KEY_OBJECT_HANDLE         (KMS_INDEX_MIN_NVM_STATIC_OBJECTS + 2UL)
#define KMS_NWK_S_KEY_OBJECT_HANDLE                  (KMS_INDEX_MIN_NVM_STATIC_OBJECTS + 3UL)
#define KMS_APP_S_KEY_OBJECT_HANDLE                  (KMS_INDEX_MIN_NVM_STATIC_OBJECTS + 4UL)
#define KMS_ZERO_KEY_OBJECT_HANDLE                   (KMS_INDEX_MIN_NVM_STATIC_OBJECTS + 5UL)
