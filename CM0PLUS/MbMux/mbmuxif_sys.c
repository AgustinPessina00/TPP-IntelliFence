...
static int8_t MBMUXIF_FeatureCm0plusRegistrationCmd(uint32_t *pBuf)
{
  ...
  switch (pBuf[0])
  {
    ...
    case FEAT_INFO_KMS_ID:
      /* ret = MBMUXIF_KmsInit(); */
      /* APP_LOG(TS_OFF, VLEVEL_L, " * CM0 : Kms registration done\r\r\n"n"); */
      break;
    ...
    case FEAT_INFO_RADIO_ID:
      ...
      /* APP_LOG(TS_OFF, VLEVEL_L, "CM0PLUS : Radio registration done\r\r\n"n"); */
      break;
    ...
    case FEAT_INFO_LORAWAN_ID:
      ...
      /* APP_LOG(TS_OFF, VLEVEL_L, "CM0PLUS : Lora registration done\r\r\n"n"); */
      break;
    ...
    case FEAT_INFO_SIGFOX_ID:
      ...
      /* APP_LOG(TS_OFF, VLEVEL_L, "CM0PLUS : Sigfox not supported\r\r\n"n"); */
      break;
