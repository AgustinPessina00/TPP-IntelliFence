...
/**
  ...
  * @brief   This file implements the CM0PLUS side wrapper of the Radio interface
...
#ifndef __RADIO_MBWRAPPER_CM0PLUS_H__
#define __RADIO_MBWRAPPER_CM0PLUS_H__
...
#endif /*__RADIO_MBWRAPPER_CM0PLUS_H__ */
