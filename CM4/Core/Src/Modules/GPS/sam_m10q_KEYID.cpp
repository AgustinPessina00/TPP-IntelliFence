...
static const uint8_t m10q_data_05[] = {0x22, 0x00, 0x31, 0x10, 0x00}; // SIGNAL-BDS_ENA
static const uint8_t m10q_data_06[] = {0x0D, 0x00, 0x31, 0x10, 0x00}; // SIGNAL-BDS_B1_ENA -> DESHABILITADO PORQUE NO PUEDE ESTAR AL MISMO TIEMPO QUE B1C (B1C default: 1).
static const uint8_t m10q_data_07[] = {0x0F, 0x00, 0x31, 0x10, 0x00}; // SIGNAL-BDS_B1C_ENA
static const uint8_t m10q_data_08[] = {0x21, 0x00, 0x11, 0x20, 0x03}; // NAVSPG-DYNMODEL
static const uint8_t m10q_data_09[] = {0x05, 0x00, 0x22, 0x20, 0x00}; // ODO-PROFILE
static const uint8_t m10q_data_10[] = {0xB3, 0x00, 0x11, 0x30, 0x14, 0x00}; // NAVSPG-OUTFIL_PACC -> SI VEMOS QUE FILTRA DEMASIADO Y NO ACTUALIZA LOS VALORES PVT PODEMOS SUBIRLE EL VALOR. AHORA ES 20M.
static const uint8_t m10q_data_11[] = {0xBA, 0x00, 0x91, 0x20, 0x00}; // MSGOUT-NMEA_ID_GGA_I2C -> LO DESHABILITO YA QUE DESHABILITAMOS LAS TRAMAS NMEA POR I2C.
static const uint8_t m10q_data_12[] = {0xBE, 0x00, 0x91, 0x20, 0x00}; // MSGOUT-NMEA_ID_GGA_SPI
static const uint8_t m10q_data_13[] = {0xBB, 0x00, 0x91, 0x20, 0x00}; // MSGOUT-NMEA_ID_GGA_UART1
static const uint8_t m10q_data_14[] = {0xAB, 0x00, 0x91, 0x20, 0x00}; // MSGOUT-NMEA_ID_RMC_I2C -> LO DESHABILITO YA QUE DESHABILITAMOS LAS TRAMAS NMEA POR I2C.
static const uint8_t m10q_data_15[] = {0xAF, 0x00, 0x91, 0x20, 0x00}; // MSGOUT-NMEA_ID_RMC_SPI
static const uint8_t m10q_data_16[] = {0xAC, 0x00, 0x91, 0x20, 0x00}; // MSGOUT-NMEA_ID_RMC_UART1
static const uint8_t m10q_data_17[] = {0xC9, 0x00, 0x91, 0x20, 0x00}; // MSGOUT-NMEA_ID_GLL_I2C
static const uint8_t m10q_data_18[] = {0xCD, 0x00, 0x91, 0x20, 0x00}; // MSGOUT-NMEA_ID_GLL_SPI
static const uint8_t m10q_data_19[] = {0xCA, 0x00, 0x91, 0x20, 0x00}; // MSGOUT-NMEA_ID_GLL_UART1
static const uint8_t m10q_data_20[] = {0xBF, 0x00, 0x91, 0x20, 0x00}; // MSGOUT-NMEA_ID_GSA_I2C
static const uint8_t m10q_data_21[] = {0xC3, 0x00, 0x91, 0x20, 0x00}; // MSGOUT-NMEA_ID_GSA_SPI
static const uint8_t m10q_data_22[] = {0xC0, 0x00, 0x91, 0x20, 0x00}; // MSGOUT-NMEA_ID_GSA_UART1
static const uint8_t m10q_data_23[] = {0xC4, 0x00, 0x91, 0x20, 0x00}; // MSGOUT-NMEA_ID_GSV_I2C
static const uint8_t m10q_data_24[] = {0xC8, 0x00, 0x91, 0x20, 0x00}; // MSGOUT-NMEA_ID_GSV_SPI
static const uint8_t m10q_data_25[] = {0xC5, 0x00, 0x91, 0x20, 0x00}; // MSGOUT-NMEA_ID_GSV_UART1
static const uint8_t m10q_data_26[] = {0xB0, 0x00, 0x91, 0x20, 0x00}; // MSGOUT-NMEA_ID_VTG_I2C
static const uint8_t m10q_data_27[] = {0xB4, 0x00, 0x91, 0x20, 0x00}; // MSGOUT-NMEA_ID_VTG_SPI
static const uint8_t m10q_data_28[] = {0xB1, 0x00, 0x91, 0x20, 0x00}; // MSGOUT-NMEA_ID_VTG_UART1
static const uint8_t m10q_data_29[] = {0x02, 0x00, 0xD0, 0x40, 0x78, 0x00, 0x00, 0x00}; // PM-POSUPDATEPERIOD -> POSICION CADA 60 SEGUNDOS
static const uint8_t m10q_data_30[] = {0x03, 0x00, 0xD0, 0x40, 0x78, 0x00, 0x00, 0x00}; // PM-ACQPERIOD -> PODRIAMOS LLEVARLO AL MISMO VALOR QUE EL POSUPDATEPERIOD. LO DEJO DE 10S PORQUE ASI EN CAMPO ABIERTO TENGO MAS ACTUALIZACIONES Y NO PERDEMOS EL FIX.
static const uint8_t m10q_data_31[] = {0x05, 0x00, 0xD0, 0x30, 0x1E, 0x00}; // PM-ONTIME -> 5 SEGUNDOS ACTUALMENTE, PODEMOS AUMENTARLO UN POCO AL TIEMPO QUE EL RECEPTOR PERMANECE ENCENDIDO CADA VEZ QUE ENTRA EN UN CICLO DE ADQUISICIÓN PARA NO PERDER MUESTRAS.
static const uint8_t m10q_data_32[] = {0x06, 0x00, 0xD0, 0x20, 0x05}; // PM-MINACQTIME
static const uint8_t m10q_data_33[] = {0x07, 0x00, 0xD0, 0x20, 0x3C}; // PM-MAXACQTIME -> SI AUMENTAMOS EL PM-ONTIME DEBERIAMOS AUMENTAR EL MAXACQTIME PARA QUE NO CORTARA LA ADQUISICIÓN ANTES DE TIEMPO.
static const uint8_t m10q_data_34[] = {0x09, 0x00, 0xD0, 0x10, 0x01}; // PM-WAITTIMEFIX
static const uint8_t m10q_data_35[] = {0x0C, 0x00, 0xD0, 0x10, 0x01}; // PM-EXTINTWAKE
static const uint8_t m10q_data_36[] = {0x01, 0x00, 0xD0, 0x20, 0x01}; // PM-OPERATEMODE
...
const M10QPayload m10q_data_payloads[M10Q_NUM_DATA_ELEMENTS] = {
    ...
    {m10q_data_06, sizeof(m10q_data_06)}, {m10q_data_07, sizeof(m10q_data_07)}, {m10q_data_08, sizeof(m10q_data_08)}, {m10q_data_09, sizeof(m10q_data_09)}, 
    {m10q_data_10, sizeof(m10q_data_10)}, {m10q_data_11, sizeof(m10q_data_11)}, {m10q_data_12, sizeof(m10q_data_12)}, 
    {m10q_data_13, sizeof(m10q_data_13)}, {m10q_data_14, sizeof(m10q_data_14)}, {m10q_data_15, sizeof(m10q_data_15)}, 
    {m10q_data_16, sizeof(m10q_data_16)}, {m10q_data_17, sizeof(m10q_data_17)}, {m10q_data_18, sizeof(m10q_data_18)}, 
    {m10q_data_19, sizeof(m10q_data_19)}, {m10q_data_20, sizeof(m10q_data_20)}, {m10q_data_21, sizeof(m10q_data_21)}, 
    {m10q_data_22, sizeof(m10q_data_22)}, {m10q_data_23, sizeof(m10q_data_23)}, {m10q_data_24, sizeof(m10q_data_24)}, 
    {m10q_data_25, sizeof(m10q_data_25)}, {m10q_data_26, sizeof(m10q_data_26)}, {m10q_data_27, sizeof(m10q_data_27)}, 
    {m10q_data_28, sizeof(m10q_data_28)}, {m10q_data_29, sizeof(m10q_data_29)}, {m10q_data_30, sizeof(m10q_data_30)}, 
    {m10q_data_31, sizeof(m10q_data_31)}, {m10q_data_32, sizeof(m10q_data_32)}, {m10q_data_33, sizeof(m10q_data_33)},
    {m10q_data_34, sizeof(m10q_data_34)}, {m10q_data_35, sizeof(m10q_data_35)}, {m10q_data_36, sizeof(m10q_data_36)}
};