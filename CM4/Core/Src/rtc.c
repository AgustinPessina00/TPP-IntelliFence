...
void MX_RTC_Init(void)
{
  ...
  */
  ...
  h.Init.AsynchPrediv = 127;
  h.Init.SynchPrediv = 255;
  ...
  h.Init.BinMode = RTC_BINARY_NONE;
  ...
  */
  ...
  if (HAL_RTC_SetTime(&h, &sTime, RTC_FORMAT_BCD) != HAL_OK)
  {
    Error_Handler();
  }
  ...
  if (HAL_RTC_SetDate(&h, &sDate, RTC_FORMAT_BCD) != HAL_OK)
  {
    Error_Handler();
  }
