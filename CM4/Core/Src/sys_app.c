...
/* USER CODE BEGIN PD */
/* Valores típicos usados por ST, podés ajustarlos luego */
#define VDD_BAT  (4200U)   /* mV: batería llena */
#define VDD_MIN  (1800U)   /* mV: mínimo de funcionamiento */

/* USER CODE END PD */

/* Private macro -------------------------------------------------------------*/
/* USER CODE BEGIN PM */
/* USER CODE BEGIN SysMeasurement */

#include <stdint.h>

void SYS_InitMeasurement(void)
{
  /* Stub: más adelante podés inicializar ADC, etc. */
}

uint16_t SYS_GetBatteryLevel(void)
{
  /* Stub: devolver batería fija en mV */
  return 3700U;   // 3.7V
}

int16_t SYS_GetTemperatureLevel(void)
{
  /* Stub: temperatura fija en °C */
  return 25;
}

/* USER CODE END SysMeasurement */
